...
def libusb1_no_error_ctrl_transfer(device, bmRequestType, bRequest, wValue, wIndex, data_or_wLength, timeout):
  try:
    ...
    print("ctrl transfer Looks ok!: %d %d" % (bmRequestType, bRequest))
    #print("ctrl transfer", ret)
  except usb.core.USBError:
     #traceback in the stack.
...
def exploit():
  ...
  libusb1_no_error_ctrl_transfer(device, 0x21, 4, 0, 0, 0, 0)  # this is Crashing. More on that later...
  dfu.release_device(device)
